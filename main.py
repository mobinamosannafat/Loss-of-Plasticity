...
BATCH_SIZE = 32
BUFFER_SIZE = 1000
MIN_REPLAY_SIZE = 32          #To Do #Parham: 1000 => Care less about previous ones
MAX_STEPS = 2000
TARGET_UPDATE_FREQ = 128
HIDDEN_LAYERS_SIZE = 64       #To Do
LEARNING_RATE = 0.01
#SWAP_EVERY = 500
...
online_network = DQN(env, hidden_size=HIDDEN_LAYERS_SIZE)
target_network = DQN(env, hidden_size=HIDDEN_LAYERS_SIZE)
